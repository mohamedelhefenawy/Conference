...
function Footer() {
  ...
  >
    <path
      d="M23.954 4.569c-.885.39-1.83.654-2.825.775 1.014-.611 1.794-1.574 2.163-2.723-.95.564-2.005.974-3.127 1.194-.897-.956-2.173-1.555-3.591-1.555-2.717 0-4.92 2.201-4.92 4.917 0 .39.045.765.13 1.124C7.69 8.094 4.066 6.13 1.64 3.161c-.427.722-.666 1.561-.666 2.475 0 1.71.87 3.213 2.188 4.096-.807-.026-1.566-.248-2.23-.616v.061c0 2.386 1.693 4.374 3.946 4.827-.413.112-.849.171-1.296.171-.314 0-.622-.03-.924-.086.631 1.953 2.445 3.377 4.6 3.417-1.68 1.318-3.8 2.104-6.104 2.104-.396 0-.79-.023-1.175-.067 2.18 1.396 4.768 2.212 7.548 2.212 9.053 0 13.998-7.496 13.998-13.986 0-.213-.004-.425-.013-.637.961-.694 1.8-1.562 2.46-2.549z"
    />
  </svg></div>
      <div className='icon'><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"><path fill="#0d121c" d="M22 16.19c0 3.64-2.17 5.81-5.81 5.81H15c-.55 0-1-.45-1-1v-5.77c0-.27.22-.5.49-.5l1.76-.03c.14-.01.26-.11.29-.25l.35-1.91a.303.303 0 00-.3-.35l-2.13.03c-.28 0-.5-.22-.51-.49l-.04-2.45c0-.16.13-.3.3-.3l2.4-.04c.17 0 .3-.13.3-.3l-.04-2.4c0-.17-.13-.3-.3-.3l-2.7.04a2.996 2.996 0 00-2.95 3.05l.05 2.75c.01.28-.21.5-.49.51l-1.2.02c-.17 0-.3.13-.3.3l.03 1.9c0 .17.13.3.3.3l1.2-.02c.28 0 .5.22.51.49l.09 5.7c.01.56-.44 1.02-1 1.02h-2.3C4.17 22 2 19.83 2 16.18V7.81C2 4.17 4.17 2 7.81 2h8.38C19.83 2 22 4.17 22 7.81v8.38z"></path></svg></div>

      </div>
    <div className='square'>
    <AnchorLink href="#home" onClick={()=>useline('#home') } className={line ==='#home' ? 'active':''}>الصفحة الرئيسية</AnchorLink>
    ...
    <div className='word'>created by <span>Cowdly</span> | all rights reserved</div>
