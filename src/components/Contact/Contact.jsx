...
function Contact() {
  ...
  <div className="flex justify-center my-8  gap-2 mx-auto flex-col md:flex-row md:flex-row-reverse">
    <iframe
      className="w-[90%] h-[60vh] rounded-xl mx-auto md:w-[35%] "
    ...
    <div className="name flex flex-col justify-center items-center gap-8 border border-[#b8eacb]   h-[60vh] rounded-xl hover:bg-[#54c084] md:w-[35%] mx-auto w-[90%]  transition duration-300 ease-in-out">
